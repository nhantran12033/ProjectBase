...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 7117dfad-ca2f-4a11-a028-213875ae81d3
```

> `7117dfad-ca2f-4a11-a028-213875ae81d3` is the password of the certificate, you can change it to any password you want.
